...
__all__ = ['cmnet_botdropfeat_doubot', 'cmnet_neck_botdropfeat_doubot',
           'cmnet_neck', 'cmnet', 'cmnet_neck_doubot', 'cmnet_doubot',
           'cmnodropnet', 'cmnodropnet_neck']
...
# Top bdnet
def cmnet_botdropfeat_doubot(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = TopBDNet(
...
def cmnet_neck_botdropfeat_doubot(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = TopBDNet(
        num_classes=num_classes,
        loss=loss,
        neck=True,
...
def cmnet_doubot(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = TopBDNet(
        num_classes=num_classes,
        loss=loss,
        neck=False,
...
def cmnet_neck_doubot(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = TopBDNet(
        num_classes=num_classes,
        loss=loss,
        neck=True,
...
# Batch dropblock
def cmnet(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = TopBDNet(
        num_classes=num_classes,
        loss=loss,
        neck=False,
...
# Batch dropblock
def cmnet_neck(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = TopBDNet(
        num_classes=num_classes,
        loss=loss,
        neck=True,
...
def cmnodropnet(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = NoDropNet(
        num_classes=num_classes,
        loss=loss,
        neck=False,
...
def cmnodropnet_neck(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = NoDropNet(
        num_classes=num_classes,
        loss=loss,
        neck=True,
