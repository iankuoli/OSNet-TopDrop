...
__all__ = ['top_bdnet_botdropfeat_doubot',
           'top_bdnet_neck_botdropfeat_doubot',
           'bdnet_neck', 'bdnet', 'top_bdnet_neck_doubot',
           'top_bdnet_doubot', 'nodropnet_neck', 'nodropnet']
...
class TopBDNet(nn.Module):
    ...
    def __init__(self, num_classes=0, loss='softmax', neck=False,
                 ...
                 double_bottleneck=False, drop_bottleneck_features=False, **kwargs):
