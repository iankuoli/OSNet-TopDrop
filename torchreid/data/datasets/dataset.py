...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            if type(self.transform) == list and len(self.transform) == 2:
                img, img_view1, img_view2 = self.transform[1](img), self.transform[0](img), self.transform[0](img)
                return [img_view1, img_view2, img], pid, camid, img_path
            else:
