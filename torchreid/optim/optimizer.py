...
AVAI_OPTIMS = ['adam', 'amsgrad', 'sgd', 'rmsprop', 'radam', 'ranger', 'ralamb', 'rangerlars']
...
def build_optimizer(
    ...
    Examples::
        ...
        >>> optimizer = deepreid.optim.build_optimizer(model, optim='sgd', lr=0.01)
    ...
    if staged_lr:
        ...
        if arc_margins is not None:
            for arc_margin in arc_margins.values():
                param_groups += list(arc_margin.parameters())
